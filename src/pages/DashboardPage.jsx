...
import { getCurrentMonth, maxBadgeLevel, visualAssets } from '../constants'
import BadgeChip from '../components/BadgeChip'
import { currency } from '../lib/format'
import { buildPieSlices, getPieBackground } from '../lib/helpers'
                ...
                <article className="inset">
                  ...
                  <div className="badge-grid">
                    {(badges?.badges || []).map((badge) => (
                      <BadgeChip key={badge.key} badge={badge} t={t} />
                    ))}
                  </div>
                </article>
